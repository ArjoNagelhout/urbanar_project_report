...
{{< fig src="images/arjo.jpg" caption="Arjo" name="whiteboard1" >}}

{{< fig src="images/IMG_3234.JPG" caption="Janiek" name="whiteboard1" >}}
...
{{< video src="images/film2.mp4" caption="Yeah we had dedication 2.0 (this time for the final video)" name="whiteboard1" gif="true">}}
{{< video src="images/film3.mp4" caption="And some atmosphere of course" name="whiteboard1" gif="true">}}
{{< /figcontainer>}}
...
{{< figcontainer >}}
{{< fig src="images/IMG_6270.JPEG" caption="Timo happy with his shots" name="whiteboard1" >}}
{{< fig src="images/IMG_6264.PNG" caption="Timo being model in AR build system" name="whiteboard1" >}}
{{< fig src="images/IMG_6265.PNG" caption="More Timo being model in AR build system" name="whiteboard1" >}}
{{< /figcontainer>}}
...
{{< figcontainer >}}
{{< fig src="images/IMG_5182.JPG" caption="He starts presenting" name="whiteboard1" >}}
{{< fig src="images/IMG_5183.JPG" caption="This image is just cursed" name="whiteboard1" >}}
{{< fig src="images/IMG_5184.JPG" caption="Arjo do be happy after his presentation" name="whiteboard1" >}}
{{< /figcontainer>}}

## Yeah and this happened
Our meetings were always a bit... "different".
{{< figcontainer >}}
{{< fig src="images/IMG_4946.JPG" caption="We will never question the creative process again" >}}
{{< fig src="images/foto3.jpg" caption="He do be chillin' on the ground" >}}
{{< fig src="images/IMG_6404.JPG" caption="Ow and this dude passed by" name="whiteboard1" >}}
{{< fig src="images/IMG_5086.JPG" caption="Vewy happy" name="whiteboard1" >}}
{{< fig src="images/IMG_6263.PNG" caption="During Demo Day Diede was not convinced about our project, so we build this cool scene during the meeting" name="whiteboard1" >}}
{{< fig src="images/IMG_3656.JPG" caption="I mean, this is THE definition of *Creativity & Aesthetics*" name="whiteboard1" >}}
{{< fig src="images/foto2.jpg" caption="Yeah this is where all the sugar bags from the 'Zwarte Doos' went" name="whiteboard1" >}}
{{< /figcontainer >}}
