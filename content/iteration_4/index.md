...
{{< figcontainer class="small">}}
{{< video src="images/unity_test.mp4" caption="The very first working version of the app where locations are generated by the programm itself" name="laptopscreen" gif="true">}}
...
{{< figcontainer class="small">}}
{{< fig src="images/utrandi.png" caption="The third user test" name="laptopscreen" >}}
