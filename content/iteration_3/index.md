...
Furthermore, we could dive deeper into what will happen if an idea has been chosen. Showing the status of the actual realization would give users more trust in the value of spending time on creating designs with this app. Furthermore, rewarding the builder of a realized idea could be done via a nameplate for example.
